...
<div class="container">
    {assign var='crumbs' value=[['label'=>'Convalida','url'=>'/affiliazioni'],['label'=>'Richiesta approvata']]}
    ...
    <div class="notification is-success">
        {icon name='check'}
        {if $isPilota}
            <strong>Documenti convalidati.</strong>
            I documenti di
            <strong>{$r.nome|default:''|escape} {$r.cognome|default:''|escape}</strong>
            sono stati approvati: il pilota può ora prenotare le sessioni.
        {else}
            ...
            è stata confermata: l'utente può ora operare sulla piattaforma.
        {/if}
    </div>
    ...
    <div class="card">
        ...
        <dl class="tp-dl">
            ...
            <dt>Stato</dt>
            <dd><span class="badge confermata">Approvata</span></dd>
        </dl>
