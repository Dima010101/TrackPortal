...
{block name=body}
<div class="container">
    {assign var='crumbs' value=[['label'=>'Promozioni','url'=>'/promozioni'],['label'=>'Nuova promozione']]}
    ...
    <div class="card tp-panel-wide">
        <form method="post"
              action="{url path="/promozioni/servizio/{$entita_id|default:0}/nuova"}"
              class="form-stack is-wide">
            {csrf_field}
            {include file='partials/form_promozione.tpl'}
            <div class="flex">
                <button class="button is-primary" type="submit">{icon name='plus'} Conferma promozione</button>
