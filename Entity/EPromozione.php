...
class EPromozione
{
    ...
    #[ORM\Column(name: 'creator_ruolo', type: 'string', length: 40, nullable: true)]
    protected ?string $creatorRuolo = null;
    ...
    public function __construct(
        ?int $creatorAccountId = null, ?string $creatorRuolo = null, ?int $veicoloNoleggioId = null, ?int $circuitoId = null, string $titolo = '',
        ...
        $this->creatorRuolo       = $creatorRuolo;
    ...
    public static function fromArray(array $r): self
    {
        return new self(
            ...
            isset($r['creator_ruolo']) && $r['creator_ruolo'] !== null ? (string)$r['creator_ruolo'] : null,
    ...
    public function getCreatorRuolo(): ?string         { return $this->creatorRuolo; }
