...
/**
 * Sottoclasse di EAccount per i gestori noleggio.
 */
#[ORM\Entity]
#[ORM\Table(name: 'azienda_noleggio')]
class EGestoreNoleggio extends EAccount
{
    public static string $ruolo = 'gestore_noleggio';
